      ...
      <div className="flex pt-16">
        ...
        <main className={`transition-all duration-300 ${sidebarCollapsed ? 'ml-20' : 'ml-64'} flex-1 p-8`}>
          <section className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/50">
              <h2 className="text-2xl font-bold mb-6">开发者信息</h2>
              <div className="flex items-center space-x-4">
                <i className="fa-brands fa-github text-4xl text-gray-800"></i>
                <div>
                  <p className="text-gray-600 mb-2">访问我的GitHub获取更多项目:</p>
                  <a 
